...
import com.luma.lumacourses.security.exception.JwtAccessDeniedHandler;
import com.luma.lumacourses.security.exception.JwtAuthEntryPoint;
...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        var provider = new DaoAuthenticationProvider(userPrincipalService);
